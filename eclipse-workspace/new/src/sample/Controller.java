...
//	private ResourceBundle resources;
	...
	public void initialize() {
		...
		//pane1.setStyle("-fx-background-image: url('sample/mario1.jpeg')");
		//pane2.setStyle("-fx-background-image: url('sample/mario2.jpg')");
		//pane3.setStyle("-fx-background-image: url('sample/mario3.jpg')");
		//pane4.setStyle("-fx-background-image: url('sample/mario4.jpg')");
